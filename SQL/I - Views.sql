...
--3. Create a view called StaffExperience that returns the 
--   name of the staff members that have taught courses and the names of the courses they have taught
--   Sort results by staff last name then first name, then course name
